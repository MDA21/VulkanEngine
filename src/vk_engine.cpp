...
void VulkanEngine::init_default_data() {
    ...
    testMeshes = loadGltfMeshes(this, "F:/VSproject/vulkanGuide/assets/basicmesh.glb").value();

}

void VulkanEngine::init_triangle_pipeline() {
    VkShaderModule triangleFragShader;
    if (!vkutil::load_shader_module("F:/VSproject/vulkanGuide/shaders/colored_triangle.frag.spv", _device, &triangleFragShader)) {
    ...
    if (!vkutil::load_shader_module("F:/VSproject/vulkanGuide/shaders/colored_triangle.vert.spv", _device, &triangleVertexShader)) {
...
void VulkanEngine::init_pipelines() {
    ...
    if (!vkutil::load_shader_module("F:/VSproject/vulkanGuide/shaders/gradient_color.comp.spv", _device, &gradientShader))
    {
        fmt::print("Error when building the compute shader \n");
    }

    VkShaderModule skyShader;
    if (!vkutil::load_shader_module("F:/VSproject/vulkanGuide/shaders/sky.comp.spv", _device, &skyShader)) {
        fmt::print("Error when building the compute shader \n");
    }
    ...
    VkPipelineLayout gradientLayout = _gradientPipelineLayout;

    _mainDeletionQueue.push_function([=]() {
        vkDestroyPipeline(_device, skyPipeline, nullptr);
        vkDestroyPipeline(_device, gradientPipeline, nullptr);
        vkDestroyPipelineLayout(_device, gradientLayout, nullptr);
    });
}
...
void VulkanEngine::init_mesh_pipeline() {
    ...
    VkShaderModule triangleVertexShader;
    if (!vkutil::load_shader_module("F:/VSproject/vulkanGuide/shaders/colored_triangle_mesh.vert.spv", _device, &triangleVertexShader)) {
        fmt::print("Error when building the triangle vertex shader module");
    }
    else {
        fmt::print("Triangle vertex shader succesfully loaded");
...
void VulkanEngine::draw()
{
    ...
    //VK_CHECK(vkAcquireNextImageKHR(_device, _swapchain, 100000000, get_current_frame()._swapchainSemaphore, nullptr, &swapchainImageIndex));
